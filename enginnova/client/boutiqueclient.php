...
<?php
 if(isset($_GET['action'])){
   if($_GET['action'] == 'voirformationdelaboutique'){
	   $idrecupere = $_GET['id'];
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
                 <div class="product product-single">
								<div class="product-thumb">
									...
									<button class="main-btn quick-view"><i class="fa fa-search-plus"></i><a href="?action=voirformationdelaboutique&amp;id=<?php echo $affichage['id'];?>">voir les details</a></button>
									<img src="../formation_images/<?php echo $affichage['titre'];?>"/>
								</div>
								<div class="product-body">
									<h3 class="product-price"><?php echo $affichage['prix'];?> <del class="product-old-price">$45.00</del></h3>
									<div class="product-rating">
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
									...
									<div class="product-btns">
										<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
										<button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
										<a href="?action=ajoutaupanier&amp;id=<?php echo $affichage['id'];?>" onclick=alertpanier()><button class="primary-btn add-to-cart" name="insertpanier" data-toggle="modal" data-target="#myModal" onclick= alertpanier()><i class="fa fa-shopping-cart">Add to cart</i></button></a>
									</div>
								</div>
							</div>
</div>
